    ...
    <a href={`/${locale}/cart`} className="relative px-3 py-2">
      <svg
        ...
        <path
          ...
          stroke="#565656"
        />
        <path d="M8 8L29.3333 8" stroke="#565656" />
        <circle cx="8.00065" cy="26.6667" r="2.66667" stroke="#565656" />
        <circle cx="22.6667" cy="26.6667" r="2.66667" stroke="#565656" />
        <path d="M10.6667 26.6667L20 26.6667" stroke="#565656" />
        <path
